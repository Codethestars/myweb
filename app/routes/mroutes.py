...
from app import app
from app.mpage9 import calculate_psychrometric, get_available_values
import os
...
@app.route('/page9')
def page9():
    """Route for HVAC page 9 (Psychrometric Calculator)"""
    return render_template('mpage9.html')

@app.route('/calculate_psychrometric', methods=['POST'])
def handle_psychrometric():
    """Handle psychrometric calculations"""
    return calculate_psychrometric()

@app.route('/get_available_values')
def get_available_values_route():
    """Get available values for psychrometric calculator dropdowns"""
    return get_available_values()
